...
### Oscillator's
    ...
    | (0 ~ 7)     |           |              | Off/On        | 1.4 ~ 62.0 Hz  | 0 ~ 100 %  |
    +-------------+-----------+--------------+---------------+----------------+------------+
    | 16          | ----      | Reserved     | ----          | ----           | ----       |
    | (8 ~ 23)    |           |              |               |                |            |
    +-------------+-----------+--------------+---------------+----------------+------------+
    | 32          | PULSE+SAW | Pulse Wave + | Mix           | PWM Rate       | PWM Depth  |
    | (24 ~ 39)   |           | Saw Waves    | Pulse ~ Saw   | 0.4 ~ 15.4 Hz  | 0 ~ 100 %  |
    +-------------+-----------+--------------+---------------+----------------+------------+
    | 48          | ----      | Reserved     | ----          | ----           | ----       |
    | (40 ~ 55)   |           |              |               |                |            |
    +-------------+-----------+--------------+---------------+----------------+------------+
    | 64          | ORGAN     | Organ Like   | Harmonics     | Vib. Rate      | Vib. Depth |
    | (56 ~ 71)   |           |              | b0 16'&5-1/3' | 0.4 ~ 15.4 Hz  | 0 ~ 100 %  |
    |             |           |              | ~ b7 1'       |                |            |
    +-------------+-----------+--------------+---------------+----------------+------------+
    | 80          | ----      | Reserved     | ----          | ----           | ----       |
    | (72 ~ 87)   |           |              |               |                |            |
    +-------------+-----------+--------------+---------------+----------------+------------+
    | 96          | BINARY    | Binary Wave  | Bits          | TODO           | TODO       |
    | (88 ~ 103)  |           |              |               |                |            |
    +-------------+-----------+--------------+---------------+----------------+------------+
    | 112         | ----      | Reserved     | ----          | ----           | ----       |
    | (104 ~ 119) |           |              |               |                |            |
    ...
    | (120 ~ 127) |           |              | 0 ~ 14.9 Hz   | 0.5 ~ 16.0     | 0 ~ 12.6   |
    +-------------+-----------+--------------+---------------+----------------+------------+
