...
const uint16_t  SAMPLING_RATE   = 62500;
...
const uint8_t   FILTER_TABLE_FRACTION_BITS              = 15;
const uint16_t  ENV_LEVEL_MAX                           = (127 << 1) << 8;
const uint8_t   ENV_CONTROLLER_STEPS_BITS               = 5;
const uint8_t   ENV_DECAY_RELEASE_RATE_DENOMINATOR_BITS = 8;
